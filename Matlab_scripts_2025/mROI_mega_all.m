...
for i=1:length(loc_tasks)
    ...
    % run the analysis
    ss=struct(...
            'swd', ['/nese/mit/group/evlab/u/ruiminga/TripleEvents/TripleEvents_data/mROI_' network '/' loc_task '_' main_task '_' date],...   % output directory
...
elseif strcmp(network, 'events_parcels-original_contrast-both')
    parcel_filepath = '/nese/mit/group/evlab/u/ruiminga/TripleEvents/TripleEvents/new_parcels_2025/';
