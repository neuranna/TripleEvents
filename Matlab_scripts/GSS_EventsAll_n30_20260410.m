...
ss=struct(...
    'swd',['/orcd/archive/evelina9/001/u/ruiminga/TripleEventsRerun_20260410/GSS_EventsAll/' my_contrast1 '_' my_contrast2 '_n30_' date],...   % output directory
...
if strcmp(expt, 'events2move_instrsep') && ismember(string(uid), ["408","776","775"])
