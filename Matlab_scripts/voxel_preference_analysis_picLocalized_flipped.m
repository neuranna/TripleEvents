...
localizer_location_file = './localizer_source_picLocalized_flipped.csv';
...
parcel_img = '../new_parcels/fROIs_filtered_overlap60_minsize200_relabeled_flipped_resampled.nii';
...
for i=1:length(loc_tasks)
    ...
    for j = 1:length(spmfiles_loc)
        ...
        contrast_name_photo = 'Pic_Sem-Perc';
        ...
        contrast_name_sent = 'Sent_Sem-Perc'
