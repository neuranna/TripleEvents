...
plot_fROI_responses <- function (df, split_by_expt=FALSE, split_by_ROIgroup=FALSE, include_objectsem=FALSE,
                                 show_legend=TRUE, show_facet_labels=TRUE, ylim=NULL, col_width=0.7, plot_title=NULL){
...
plot_fROI_responses(dat, split_by_ROIgroup = TRUE, ylim=c(-1,3.5), col_width=0.7)
