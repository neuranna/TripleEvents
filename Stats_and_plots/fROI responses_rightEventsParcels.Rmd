...
```{r}
for (prefix in c('events', 'events_flipped', 'events_picContrast', 'events_flipped_picContrast', 'events_sentContrast', 'events_flipped_sentContrast')) {
event_expts = c('EventsOrig_instrsep_2runs', 'events2move_instrsep', 'EventsRev_instrsep')
dat = read_data(, event_expts)
...
ggsave(paste(plot_dir, prefix, plot_name,' by ROI group.png',sep=''), 
...
ggsave(paste(plot_dir, prefix, plot_name,' by expt.png',sep=''), 
