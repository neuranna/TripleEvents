% EventsAll parcels
% Events2move fROIs
% estimate responses to langloc conditions
...
ss=struct(...
    'swd', ['/home/annaiv/annaiv/TripleEvents/mROI_EventsAllparcels_Events2move/' my_contrast1 '_' my_contrast2 '_' date],...         % output directory
