...
experiments=struct(...
    'name','EventsRev',...% events subjects
    'pwd1','/mindhive/evlab/u/Shared/SUBJECTS',...
    'pwd2','firstlevel_EventsRev',...
...
ss=struct(...
    'swd',['/home/annaiv/annaiv/TripleEvents/GSS_EventsRev_old/' my_contrast1 '_' my_contrast2 '_' date],...   % output directory
