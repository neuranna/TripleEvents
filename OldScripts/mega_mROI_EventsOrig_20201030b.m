...
% diff from 20201030 - "2runs" version of EventsOrig

function [] = mega_mROI_EventsOrig_20201030b(index)
% adapted for slurm
...
loc_tasks = {'SWNlocIPS168', 'SWNlocIPS168'};
loc_contrasts = {'N-S','S-N'};

% critical tasks - lang, EventsOrig
crit_tasks = {'SWNlocIPS168', 'EventsOrig_instrsep_2runs'};
