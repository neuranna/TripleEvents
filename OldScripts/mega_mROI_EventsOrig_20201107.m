...
% diff from 20201030 - "2runs" version of EventsOrig and SWNloc
% updated parcel paths too

function [] = mega_mROI_EventsOrig_20201107(index)
% adapted for slurm
...
loc_tasks = {'SWNlocIPS168_2runs', 'SWNlocIPS168_2runs'};
loc_contrasts = {'N-S','S-N'};

% critical tasks - lang, EventsOrig
crit_tasks = {'SWNlocIPS168_2runs', 'EventsOrig_instrsep_2runs'};
