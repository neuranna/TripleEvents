...
dat1.lang = read.csv('../data/EventsOrig/langloc_lang.csv')
dat1.events = read.csv('../data/EventsOrig/langloc_events.csv')
...
dat1 = dat1 %>%
  ...
  filter(!is.na(Effect))
dat1$ROI = factor(dat1$ROI, levels = c('IFGorb', 'IFG', 'MFG', 'AntTemp', 'PostTemp', 'AngG'))
```
...
ggsave('langparcels_EventsOrig_draft.png', width=16, height=16, units='cm')
```
